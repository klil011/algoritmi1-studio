...
static upo_ht_sepchain_list_node_t* upo_ht_sepchain_list_node_create();
static upo_ht_key_list_node_t* upo_ht_key_list_node_create();
...
/*** BEGIN of HASH TABLE with SEPARATE CHAINING (based on ordered linked list) ***/

struct upo_ht_sepchain_olist_node_s
{
    void *key;
    void *value;
    struct upo_ht_sepchain_olist_node_s *next;
};
...
{
    upo_ht_sepchain_olist_node_t *head;
};
...
static upo_ht_sepchain_olist_node_t* upo_ht_sepchain_olist_node_create();



/*** END of HASH TABLE with SEPARATE CHAINING (based on ordered linked list) ***/

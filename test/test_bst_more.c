...
static void test_bst_value_depth();
static void test_bst_keys_le();
...
void test_rank() {
    ...
    rank = upo_bst_rank(bst, &rank0);
    assert(rank == 0);

}


void test_bst_value_depth() {
    ...
    returned_value = upo_bst_get_value_depth(bst, &keys[5], &depth);
    assert(*returned_value == values[5]);
    ...
    returned_value = upo_bst_get_value_depth(bst, &keys5[8], &depth);
    assert(*returned_value == values[8]);

    assert(depth == 3);

}

void test_bst_keys_le() {
...
void test_predecessor() {
    ...
    int *key_returned = NULL;

    key_returned = upo_bst_predecessor(bst, &keys[9]);
    assert(key_returned == &keys[8]);

    key_returned = upo_bst_predecessor(bst, &keys[4]);
    assert(key_returned == NULL);
    ...
    key_returned = upo_bst_predecessor(bst, &keys5[0]);
    assert(key_returned == &keys5[5]);
...
int main()
{
    ...
    printf("Test case 'value & depth'...");
    fflush(stdout);
    test_bst_value_depth();
    printf("OK\n");

    printf("Test case 'keys le'...");
    fflush(stdout);
    test_bst_keys_le();
    printf("OK\n");
